...
import com.enesource.jump.web.dto.ExcelFuHeMonthImport;
import com.enesource.jump.web.dto.ExcelMonthImport;
import com.enesource.jump.web.utils.StringUtil;

public class CheckExcelMonthFuHeImportDTOExcelVerifyHandler implements IExcelVerifyHandler<ExcelFuHeMonthImport> {

	@Override
	public ExcelVerifyHandlerResult verifyHandler(ExcelFuHeMonthImport obj) {
